...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--toolchain=msvc --enable-shared --disable-doc --disable-protocols --disable-encoders --disable-decoders --disable-indevs --disable-outdevs --disable-filters --disable-devices --disable-muxers --disable-bsfs --disable-parsers --enable-parser=vp3 --enable-parser=vp8 --enable-parser=vp9 --disable-programs --enable-decoder=vp3 --enable-decoder=vp5 --enable-decoder=vp6 --enable-decoder=vp6a --enable-decoder=vp6f --enable-decoder=vp7 --enable-decoder=vp8 --enable-decoder=vp9 --enable-decoder=opus --enable-parser=opus --enable-demuxer=webm_dash_manifest --enable-demuxer=wav --enable-protocol=http --enable-swscale --enable-decoder=vorbis --enable-parser=vorbis --enable-demuxer=ogg
prefix=/usr/local
...
CC_IDENT=Microsoft (R) C/C++ Optimizing Compiler Version 19.00.23026 for x86
ARCH=x86
INTRINSICS=none
CC=cl
CXX=g++
...
CFLAGS= -nologo -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_WARNINGS    -Z7 -W4 -wd4244 -wd4127 -wd4018 -wd4389 -wd4146 -wd4057 -wd4204 -wd4706 -wd4305 -wd4152 -wd4324 -we4013 -wd4100 -wd4214 -wd4307 -wd4273 -wd4554 -wd4701 -O2   -Oy-
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS= -nologo -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_WARNINGS  -Z7
AS_C=-c
AS_O=-Fo$@
CC_C=-c
CC_E=-P -Fi$@
...
libavformat_VERSION=57.13.100
libavformat_VERSION_MAJOR=57
libavformat_VERSION_MINOR=13
